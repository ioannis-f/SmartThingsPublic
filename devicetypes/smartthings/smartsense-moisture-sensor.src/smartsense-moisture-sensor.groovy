...
metadata {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"bigTile", type: "lighting", width: 6, height: 4, canChangeIcon: true){
            ...
            tileAttribute ("water", key: "SECONDARY_CONTROL") {
				attributeState "device.water", label:'The Sensor is currently ${currentValue}'
			}
		}
		...
		main (["bigTile"])
		details(["bigTile", "water", "temperature", "battery", "refresh"])
	}
}
